...
#https://raw.githubusercontent.com/OscarFHC/IGP_LabExp/master/Analysis/IGP_II_20170419_1.csv
...
The attack rate and the handing time for IG predator when consuming IG prey are estimated to be `r round(summary(Type2_mod)$coefficients[1,1], 4)` and `r round(summary(Type2_mod)$coefficients[2,1], 4)` respectively. 
