...
dat=read.table(file="K:/IGP exp_in lab/ProgressReport_20171115/IGP_II_20170419_1.csv", sep=",", header=TRUE, fill=TRUE)
...
dat.mod = read.table(file="K:/IGP exp_in lab/ProgressReport_20171115/Type2.csv", sep=",", header=TRUE, fill=TRUE)
dat.mod = dat.mod %>%
...
```{r}
dat.mod_I = read.table(file="K:/IGP exp_in lab/ProgressReport_20171115/Type1.csv", sep=",", header=TRUE, fill=TRUE)
dat.mod_I = dat.mod_I %>%
...
Bac_raw = read.table(file="K:/IGP exp_in lab/ProgressReport_20171115/IGP_II_20170419_bac2.csv",
...
BC_Type2=read.table(file="K:/IGP exp_in lab/ProgressReport_20171115/BonC_Type2_20171112.csv", sep=",",header=T,fill=T)
