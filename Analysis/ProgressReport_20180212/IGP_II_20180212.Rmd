...
ggplot() +
  ...
  geom_line(data = dat_mod_I, aes(x = alpha, y = Pred), size = 1.5, linetype = "dashed", color = "blue") + 
  labs(x=expression(paste("Contact probability (", alpha, ")")),
...
ggplot() +
  ...
  geom_line(data = dat_mod_I, aes(x = alpha, y = Cons), size = 1.5, linetype = "dashed", color = "blue") + 
  labs(x=expression(paste("Contact probability (", alpha, ")")),
...
ggplot() +
  ...
  geom_line(dat = dat_mod_I, aes(x = alpha, y = Res), size = 1.5, linetype = "dashed", color = "blue") + 
  labs(x=expression(paste("Contact probability (", alpha, ")")),
...
```{r, loading Type I model result, echo=FALSE}
dat_mod_II = read.table(file="https://raw.githubusercontent.com/OscarFHC/IGP_LabExp/master/Analysis/Type2ModResults/Type2_e2_4.5_p_5..csv", sep=",", header=FALSE, fill=TRUE)
